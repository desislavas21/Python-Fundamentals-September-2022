...
# On the first line, you will receive the quantity of decorations you should buy each time you go shoppin
# On the second line, you will receive the days left until Christmas.
# There are 4 types of decorations, and each piece costs a certain price. Also, each time you go shopping for a concrete type of decoration,
# your Christmas spirit is improved by some points:
...
for day in range(1, remaining_days + 1):
    ...
    if day % 10 == 0:
        spirit -= 20
        money += (tree_skirt + tree_lights + tree_garland)
